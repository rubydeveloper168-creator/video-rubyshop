   ...
   return (
      <div>
         <div className="flex items-center gap-6">
            <CategoryForm title="Add New Category" handler={<Button>Add New Category</Button>} lastPosition={lastPosition} />
         ...
         {categories.length > 0 ? (
               ...
               {defaultCategory && (
                  <Card key={defaultCategory.id} className="p-6">
                     ...
                     <div className="space-y-1">
                        <p className="font-medium">Protected Category</p>
                        <p className="text-muted-foreground text-sm">
                           When a specific category is deleted, all courses in that category will be moved to this default category. So default
                           category cannot be edited or removed.
                        </p>
                     </div>
                  </Card>
               )}
            ...
            <Card className="mt-6 border-t border-gray-300 p-6">
               <h2 className="text-center">There no category created</h2>
            </Card>
         )}
      </div>
   );
