    ...
    return (
        <div className="container mx-auto max-w-2xl space-y-6">
            <div className="flex items-start gap-3 rounded-xl border border-green-200 bg-green-50 px-5 py-4 dark:border-green-900 dark:bg-green-950/30">
                ...
                <div>
                    <p className="font-semibold text-green-800 dark:text-green-300">Video uploaded successfully</p>
                    <p className="text-sm text-green-700 dark:text-green-400">
                        <span className="font-medium">{course.title}</span> — export the QR poster below to share your course.
                    </p>
                </div>
            </div>
