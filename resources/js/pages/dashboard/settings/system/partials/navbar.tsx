      ...
      <Card>
            ...
            <div className="flex items-center justify-between">
               <div>
                  ...
                  <CardDescription className="hidden sm:block">
                     Interactive preview of {navbar.title} ({navbar.slug})
                  </CardDescription>
               </div>
         ...
         {showEditor ? (
            ...
            <CardContent className="space-y-6 p-5">
               <div>
                  <p className="text-muted-foreground mb-1 text-sm">Before Login</p>
                  <NavbarPreview auth={false} navbar={navbar} />
               </div>

               <div>
                  <p className="text-muted-foreground mb-1 text-sm">After Login</p>
