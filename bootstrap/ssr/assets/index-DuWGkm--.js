...
import InstructorsTableColumn from "./instructors-table-columns-T73PYp35.js";
...
const Index = (props) => {
  ...
  const table = useReactTable({
    ...
    columns: InstructorsTableColumn(isAdmin),
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(Link, { href: route("instructors.create"), children: /* @__PURE__ */ jsx(Button, { children: "Add New Instructor" }) }),
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsx(TableFooter, { className: "p-5 sm:p-7", routeName: "instructors.index", paginationInfo: props.instructors })
    ] })
  ] });
};
