...
const NewCourses = () => {
  ...
  return /* @__PURE__ */ jsxs(Section, { customize, pageSection: newCoursesSection, containerClass: "py-20", contentClass: "relative z-10", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "after:pointer-events-none after:absolute after:top-20 after:-left-10 after:h-[240px] after:w-[240px] after:rounded-full after:bg-[rgba(97,95,255,1))] after:blur-[290px] after:content-['']" }),
    /* @__PURE__ */ jsx("div", { className: "after:pointer-events-none after:absolute after:-right-10 after:bottom-0 after:h-[240px] after:w-[240px] after:rounded-full after:bg-[rgba(0,167,111,1)] after:blur-[290px] after:content-['']" })
  ] });
};
export {
