...
const PayoutsTableColumn = [
  ...
  },
  {
    ...
    cell: ({ row }) => /* @__PURE__ */ jsx("div", { className: "pr-4 text-end", children: /* @__PURE__ */ jsx(Button, { asChild: true, type: "button", children: /* @__PURE__ */ jsx("a", { href: route("payouts.gateway.index", { slug: "web", request_id: row.original.id }), children: "Pay" }) }) })
  }
];
export {
