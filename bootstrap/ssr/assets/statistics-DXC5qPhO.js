...
const Statistics = () => {
  ...
  return /* @__PURE__ */ jsx(Section, { customize, pageSection: statisticsSection, containerClass: "relative z-10 py-11", children: /* @__PURE__ */ jsx(Card, { className: "text-primary-foreground dark:text-primary flex flex-col items-center justify-between gap-20 border-none bg-[#004B50] p-10 !shadow-none md:flex-row md:gap-28 md:px-[120px]", children: statisticsSection == null ? void 0 : statisticsSection.properties.array.map((statistic) => /* @__PURE__ */ jsxs("div", { children: [
