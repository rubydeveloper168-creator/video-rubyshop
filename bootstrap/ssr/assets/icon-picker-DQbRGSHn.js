...
import { a as Tooltip, b as TooltipTrigger, c as TooltipContent } from "./tooltip-DswKljFZ.js";
...
const blocks = [["rect", { "width": "7", "height": "7", "x": "14", "y": "3", "rx": "1" }], ["path", { "d": "M10 21V8a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-5a1 1 0 0 0-1-1H3" }]];
...
const dessert = [["circle", { "cx": "12", "cy": "4", "r": "2" }], ["path", { "d": "M10.2 3.2C5.5 4 2 8.1 2 13a2 2 0 0 0 4 0v-1a2 2 0 0 1 4 0v4a2 2 0 0 0 4 0v-4a2 2 0 0 1 4 0v1a2 2 0 0 0 4 0c0-4.9-3.5-9-8.2-9.8" }], ["path", { "d": "M3.2 14.8a9 9 0 0 0 17.6 0" }]];
...
const egg = [["path", { "d": "M12 22c6.23-.05 7.87-5.57 7.5-10-.36-4.34-3.95-9.96-7.5-10-3.55.04-7.14 5.66-7.5 10-.37 4.43 1.27 9.95 7.5 10z" }]];
...
const ligature = [["path", { "d": "M8 20V8c0-2.2 1.8-4 4-4 1.5 0 2.8.8 3.5 2" }], ["path", { "d": "M6 12h4" }], ["path", { "d": "M14 12h2v8" }], ["path", { "d": "M6 20h4" }], ["path", { "d": "M14 20h4" }]];
...
const map = [["path", { "d": "M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z" }], ["path", { "d": "M15 5.764v15" }], ["path", { "d": "M9 3.236v15" }]];
...
const megaphone = [["path", { "d": "m3 11 18-5v12L3 14v-3z" }], ["path", { "d": "M11.6 16.8a3 3 0 1 1-5.8-1.6" }]];
...
const pocket = [["path", { "d": "M4 3h16a2 2 0 0 1 2 2v6a10 10 0 0 1-10 10A10 10 0 0 1 2 11V5a2 2 0 0 1 2-2z" }], ["polyline", { "points": "8 10 12 14 16 10" }]];
...
const radio = [["path", { "d": "M4.9 19.1C1 15.2 1 8.8 4.9 4.9" }], ["path", { "d": "M7.8 16.2c-2.3-2.3-2.3-6.1 0-8.5" }], ["circle", { "cx": "12", "cy": "12", "r": "2" }], ["path", { "d": "M16.2 7.8c2.3 2.3 2.3 6.1 0 8.5" }], ["path", { "d": "M19.1 4.9C23 8.8 23 15.1 19.1 19" }]];
...
const shrub = [["path", { "d": "M12 22v-7l-2-2" }], ["path", { "d": "M17 8v.8A6 6 0 0 1 13.8 20H10A6.5 6.5 0 0 1 7 8a5 5 0 0 1 10 0Z" }], ["path", { "d": "m14 14-2 2" }]];
...
const stamp = [["path", { "d": "M5 22h14" }], ["path", { "d": "M19.27 13.73A2.5 2.5 0 0 0 17.5 13h-11A2.5 2.5 0 0 0 4 15.5V17a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-1.5c0-.66-.26-1.3-.73-1.77Z" }], ["path", { "d": "M14 13V8.5C14 7 15 7 15 5a3 3 0 0 0-3-3c-1.66 0-3 1-3 3s1 2 1 3.5V13" }]];
...
const iconNodes = {
  ...
  "clock-6": [["path", { "d": "M12 16.5V6" }], ["circle", { "cx": "12", "cy": "12", "r": "10" }]],
  ...
  "heart-minus": [["path", { "d": "M13.5 19.5 12 21l-7-7c-1.5-1.45-3-3.2-3-5.5A5.5 5.5 0 0 1 7.5 3c1.76 0 3 .5 4.5 2 1.5-1.5 2.74-2 4.5-2a5.5 5.5 0 0 1 5.402 6.5" }], ["path", { "d": "M15 15h6" }]],
  ...
  "heart-plus": [["path", { "d": "M13.5 19.5 12 21l-7-7c-1.5-1.45-3-3.2-3-5.5A5.5 5.5 0 0 1 7.5 3c1.76 0 3 .5 4.5 2 1.5-1.5 2.74-2 4.5-2a5.5 5.5 0 0 1 5.402 6.5" }], ["path", { "d": "M15 15h6" }], ["path", { "d": "M18 12v6" }]],
  ...
  "house-plus": [["path", { "d": "M12.662 21H5a2 2 0 0 1-2-2v-9a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v2.475" }], ["path", { "d": "M14.959 12.717A1 1 0 0 0 14 12h-4a1 1 0 0 0-1 1v8" }], ["path", { "d": "M15 18h6" }], ["path", { "d": "M18 15v6" }]],
  "house-wifi": [["path", { "d": "M9.5 13.866a4 4 0 0 1 5 .01" }], ["path", { "d": "M12 17h.01" }], ["path", { "d": "M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" }], ["path", { "d": "M7 10.754a8 8 0 0 1 10 0" }]],
  house,
  ...
  lectern,
  "letter-text": [["path", { "d": "M15 12h6" }], ["path", { "d": "M15 6h6" }], ["path", { "d": "m3 13 3.553-7.724a.5.5 0 0 1 .894 0L11 13" }], ["path", { "d": "M3 18h18" }], ["path", { "d": "M3.92 11h6.16" }]],
  ...
  "list-collapse": [["path", { "d": "M10 12h11" }], ["path", { "d": "M10 18h11" }], ["path", { "d": "M10 6h11" }], ["path", { "d": "m3 10 3-3-3-3" }], ["path", { "d": "m3 20 3-3-3-3" }]],
  "list-end": [["path", { "d": "M16 12H3" }], ["path", { "d": "M16 6H3" }], ["path", { "d": "M10 18H3" }], ["path", { "d": "M21 6v10a2 2 0 0 1-2 2h-5" }], ["path", { "d": "m16 16-2 2 2 2" }]],
  "list-filter-plus": [["path", { "d": "M10 18h4" }], ["path", { "d": "M11 6H3" }], ["path", { "d": "M15 6h6" }], ["path", { "d": "M18 9V3" }], ["path", { "d": "M7 12h8" }]],
  ...
  "scan-heart": [["path", { "d": "M11.246 16.657a1 1 0 0 0 1.508 0l3.57-4.101A2.75 2.75 0 1 0 12 9.168a2.75 2.75 0 1 0-4.324 3.388z" }], ["path", { "d": "M17 3h2a2 2 0 0 1 2 2v2" }], ["path", { "d": "M21 17v2a2 2 0 0 1-2 2h-2" }], ["path", { "d": "M3 7V5a2 2 0 0 1 2-2h2" }], ["path", { "d": "M7 21H5a2 2 0 0 1-2-2v-2" }]],
  ...
  workflow,
  worm,
  "wrap-text": [["path", { "d": "m16 16-2 2 2 2" }], ["path", { "d": "M3 12h15a3 3 0 1 1 0 6h-4" }], ["path", { "d": "M3 18h7" }], ["path", { "d": "M3 6h18" }]],
  wrench,
  x,
  youtube,
...
const IconPickerTooltip = ({ name, onSelect }) => {
  const [hoveredIcon, setHoveredIcon] = useState("");
  return /* @__PURE__ */ jsxs(Tooltip, { children: [
    /* @__PURE__ */ jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx(Button, { size: "icon", variant: "outline", onClick: () => onSelect == null ? void 0 : onSelect(name), onMouseOver: () => setHoveredIcon(name), children: /* @__PURE__ */ jsx(DynamicIcon, { name }) }) }),
    /* @__PURE__ */ jsx(TooltipContent, { children: /* @__PURE__ */ jsx("p", { children: hoveredIcon }) })
  ] });
};
const IconPicker = ({ enableSearch = true, onSelect }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    enableSearch && /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "email", children: "Select Icon" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative w-full", children: [
        ...
        /* @__PURE__ */ jsx(Search, { className: "absolute top-3 left-4 z-10 h-4 w-4 text-gray-700" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-4", children: filteredIcons.map((name) => /* @__PURE__ */ jsx(IconPickerTooltip, { name, onSelect }, name)) })
  ] });
};
export {
  IconPicker as I
