  ...
  return /* @__PURE__ */ jsxs(Card, { className: "p-4 sm:p-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-6 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold", children: "Paytm Settings" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-500", children: "Configure Paytm payment gateway" })
      ] }),
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-2", children: [
          ...
          /* @__PURE__ */ jsx(Label, { htmlFor: "status", className: "text-gray-500", children: data.test_mode ? "Using Staging Environment" : "Using Production Environment" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "border-b pb-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-6 md:grid-cols-2", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Label, { children: "Merchant ID/Public Key *" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                name: "public_key",
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors.public_key }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-500", children: data.test_mode ? "Use your staging merchant ID" : "Use your production merchant ID" })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Label, { children: "Merchant Key/Secret Key *" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                name: "secret_key",
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-500", children: data.test_mode ? "Use your staging merchant key" : "Use your production merchant key" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500", children: data.active ? "Paytm is currently enabled" : "Paytm is currently disabled" }),
