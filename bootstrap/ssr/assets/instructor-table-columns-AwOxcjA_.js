...
const InstructorTableColumn = [
  ...
  {
    id: "expiry_date",
    header: () => /* @__PURE__ */ jsx("div", { className: "pr-4 text-end", children: "Expiry Date" }),
    cell: ({ row }) => {
      if (!row.original.expiry_date) {
        return /* @__PURE__ */ jsx("div", { className: "pr-4 text-end", children: /* @__PURE__ */ jsx(Badge, { className: "bg-green-100 text-green-800 hover:bg-green-100", children: "Lifetime access" }) });
      }
