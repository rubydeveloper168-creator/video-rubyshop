  ...
  return /* @__PURE__ */ jsxs(Section, { customize, pageSection: testimonialsSection, containerClass: "py-20", contentClass: "relative z-10", children: [
    ...
    /* @__PURE__ */ jsx(
      Carousel,
      {
        ...
        children: /* @__PURE__ */ jsx(CarouselContent, { children: testimonialsSection == null ? void 0 : testimonialsSection.properties.array.map((review) => /* @__PURE__ */ jsx(CarouselItem, { className: "md:basis-1/2 lg:basis-1/3 xl:basis-1/4", children: /* @__PURE__ */ jsx("div", { className: "h-full px-1.5 py-0.5", children: /* @__PURE__ */ jsx(ReviewCard1, { review }) }) }, review.id)) })
      }
    ),
