...
const Overview = () => {
  ...
  return /* @__PURE__ */ jsx(Section, { customize: props.customize, pageSection: overviewSection, containerClass: "py-20", contentClass: "text-center", children: /* @__PURE__ */ jsx("div", { className: "relative grid grid-cols-1 gap-7 sm:grid-cols-2 md:grid-cols-4", children: overviewSection == null ? void 0 : overviewSection.properties.array.map((stat, index) => {
        ...
        children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx(DynamicIcon, { name: stat.icon, className: "h-8 w-8 text-white" })
            }
          ),
          /* @__PURE__ */ jsxs("div", { className: "mt-4 space-y-2", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-6", children: stat.title })
          ] })
        ]
      },
      `element-${index}`
